...
- **TailwindCSS**: Styled components for maintainable, modular CSS.
...
- Configuring **AWS CDK** to deploy necessary cloud infrastructure to ensure site was highly avilable and cost effective
